...
@section('content')
                        ...
                        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                            <div class="max-w-3xl slide-content text-white">
                                ...
                                <div class="flex flex-wrap gap-4">
                                    <a href="#services" class="px-8 py-3.5 bg-gradient-to-r from-sky-500 to-sky-600 hover:from-sky-400 hover:to-sky-500 text-white font-bold rounded-lg shadow-lg hover:shadow-sky-500/30 hover:scale-105 transition-all duration-300">
                                        Lihat Produk
                                    </a>
                                    <a href="#contact" class="px-8 py-3.5 bg-white/10 backdrop-blur-md hover:bg-white/20 text-white border border-white/30 font-bold rounded-lg hover:scale-105 transition-all duration-300">
                                        Hubungi Kami
                                    </a>
                                </div>
                            </div>
    ...
    <section id="about" class="relative py-24 bg-slate-50 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                {{-- Left Side: Text --}}
                <div class="lg:col-span-7 scroll-animate" data-animation="animate-fade-in-left">
                ...
                <div class="lg:col-span-5 relative scroll-animate" data-animation="animate-fade-in-right">
    ...
    <section id="visi-misi" class="py-24 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center max-w-3xl mx-auto mb-16 scroll-animate" data-animation="animate-scale-in">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 mt-12">
                {{-- Visi Card --}}
                <div class="glass-dark p-8 sm:p-10 rounded-2xl shadow-xl flex flex-col justify-between scroll-animate" data-animation="animate-fade-in-left">
                    <div>
                ...
                {{-- Misi Card --}}
                <div class="glass-dark p-8 sm:p-10 rounded-2xl shadow-xl flex flex-col justify-between scroll-animate" data-animation="animate-fade-in-right">
                    <div>
    ...
    <section id="services" class="py-24 bg-white relative">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16 scroll-animate" data-animation="animate-scale-in">
                ...
                <h2 class="text-3xl sm:text-4xl font-extrabold text-slate-800 mb-5 section-underline">Produk & Jasa</h2>
            ...
            <div class="flex flex-wrap items-center justify-center gap-3 mb-12 scroll-animate" data-animation="animate-fade-in-up">
                <button onclick="filterCategory('all')" id="cat-btn-all" class="filter-btn active px-6 py-2.5 rounded-full text-sm font-semibold border border-slate-200 text-slate-600 bg-slate-50 hover:bg-slate-100 cursor-pointer">
                    Semua Produk
                </button>
                @foreach($categories as $category)
                    <button onclick="filterCategory('{{ Str::slug($category) }}')" id="cat-btn-{{ Str::slug($category) }}" class="filter-btn px-6 py-2.5 rounded-full text-sm font-semibold border border-slate-200 text-slate-600 bg-slate-50 hover:bg-slate-100 cursor-pointer">
                        {{ $category }}
                    </button>
                @endforeach
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                @forelse($services as $service)
                    <div class="service-card group bg-slate-50 rounded-2xl overflow-hidden border border-slate-150/70 shadow-sm hover:shadow-xl hover:-translate-y-2 card-hover" data-category="{{ Str::slug($service->category) }}">
                        {{-- Image area --}}
                        ...
                        <div class="p-6">
                            ...
                            <a href="#contact" class="inline-flex items-center gap-2 text-sky-500 font-bold text-sm hover:text-sky-600 group/link">
    ...
    <section id="contact" class="py-24 bg-slate-50 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-16">
                {{-- Left: Contact Info --}}
                <div class="lg:col-span-5 scroll-animate" data-animation="animate-fade-in-left">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start gap-4">
                            <span class="flex items-center justify-center w-12 h-12 rounded-xl bg-white text-sky-500 shrink-0 shadow-md border border-slate-100">
                        ...
                        {{-- WhatsApp --}}
                        <div class="flex items-start gap-4">
                            <span class="flex items-center justify-center w-12 h-12 rounded-xl bg-white text-green-500 shrink-0 shadow-md border border-slate-100">
                ...
                {{-- Right: Form --}}
                <div class="lg:col-span-7 scroll-animate" data-animation="animate-fade-in-right">
                    <div class="bg-white p-8 sm:p-10 rounded-2xl shadow-xl border border-slate-100 relative">
                        ...
                        <form method="POST" action="{{ route('contact.send') }}" enctype="multipart/form-data" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" id="name" name="name" required value="{{ old('name') }}"
                                        class="w-full px-4 py-3 border border-slate-200 rounded-lg text-sm focus:border-sky-500 focus:ring-1 focus:ring-sky-500 focus:outline-none transition-all">
                            ...
                            <div>
                                ...
                                <textarea id="message" name="message" rows="5" required
                                    class="w-full px-4 py-3 border border-slate-200 rounded-lg text-sm focus:border-sky-500 focus:ring-1 focus:ring-sky-500 focus:outline-none transition-all resize-y">{{ old('message') }}</textarea>
    ...
    <script>
        ...
        function filterCategory(slug) {
            ...
            document.querySelectorAll('.filter-btn').forEach(btn => {
                btn.classList.remove('active', 'bg-sky-500', 'text-white', 'shadow-lg');
